    ...
    >
      ...
      <div class="space-y-1">
        ...
        <p
          class="text-sm text-sand-11 group-hover:text-sand-12 transition ease-in-out duration-700"
        >
          Level up your development and Adonis skills with hours of video content, from beginner to
          advanced, through databases, testing, and more.
        </p>
      </div>
    </article>
    ...
    >
      ...
      <div class="space-y-1">
        ...
        <p
          class="text-sm text-sand-11 group-hover:text-sand-12 transition ease-in-out duration-700"
        >
          Supercharge your AdonisJS application with packages built and maintained by both the core
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
      ...
      >
        ...
        <p
          class="mt-4 text-sm text-sand-11 group-hover:text-sand-12 transition ease-in-out duration-100"
        >
          From JSON API tests using Open API schema to browser tests with Playwrighht, it comes with
